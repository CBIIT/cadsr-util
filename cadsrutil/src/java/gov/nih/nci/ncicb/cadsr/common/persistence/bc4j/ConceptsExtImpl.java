...
public class ConceptsExtImpl extends EntityImpl 
{
  ...
  public static final int DEFINITIONSOURCE = 11;
  ...
  public static final int CONID = 18;
  public static final int EVSSOURCE = 19;
  public static final int CONTEXTS = 20;
  public static final int REPRESENTATION = 21;
  public static final int COMPONENTCONCEPTSEXT = 22;
  ...
  /**
   * 
   *  Gets the attribute value for EvsSource, using the alias name EvsSource
   */
  ...
  /**
   * 
   *  Sets <code>value</code> as the attribute value for EvsSource
   */
   ...
   */
  public static Key createPrimaryKey(String conIdseq)
  {
    return new Key(new Object[] {conIdseq});
  }
