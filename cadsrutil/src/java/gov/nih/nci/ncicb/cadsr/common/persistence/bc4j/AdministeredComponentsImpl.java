...
public class AdministeredComponentsImpl extends EntityImpl 
{
   ...
   */
  public AdministeredComponentsImpl()
  {
  }
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (EntityDefImpl)EntityDefImpl.findDefObject("gov.nih.nci.ncicb.cadsr.common.persistence.bc4j.AdministeredComponents");
    }
  ...
  /**
   * 
   * Gets the attribute value for ActlName, using the alias name ActlName
   */
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for ActlName
   */
  ...
  /**
   * 
   * Gets the attribute value for StewaIdseq, using the alias name StewaIdseq
   */
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for StewaIdseq
   */
