...
public class ClassificationSchemesViewRowImpl extends ViewRowImpl 
{
   ...
   */
  public ClassificationSchemesViewRowImpl()
  {
  }
  ...
  {
    return (ClassificationSchemesImpl)getEntity(0);
  }
  ...
  /**
   * 
   * Gets the attribute value for CSTL_NAME using the alias name CstlName
   */
  ...
  /**
   * 
   * Sets <code>value</code> as attribute value for CSTL_NAME using the alias name CstlName
   */
  ...
  /**
   * 
   * Gets the attribute value for LABEL_TYPE_FLAG using the alias name LabelTypeFlag
   */
  ...
  /**
   * 
   * Sets <code>value</code> as attribute value for LABEL_TYPE_FLAG using the alias name LabelTypeFlag
   */
  ...
  /**
   * 
   * Gets the associated <code>Row</code> using master-detail link ContextsView
   */
  public oracle.jbo.Row getContextsView() {
    return (oracle.jbo.Row)getAttributeInternal(CONTEXTSVIEW);
  }
  public String getContextName() {
    String conteName = (String)getContextsView().getAttribute("Name");
    return conteName;
  }
